module set_inputs
  ...
  integer,public :: residual_out_freq= 100
  integer,public :: limiter_scheme = 0  ! 0: none, 1: Van Leer, 2: Minmod
  integer,public :: freeze_limiter_iter =10000 ! Freeze limiters after this iteration
